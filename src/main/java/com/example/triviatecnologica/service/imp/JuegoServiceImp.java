...
public class JuegoServiceImp implements JuegoService {
    ...
    public Categoria obtenerCategoriaAzar() {
        int numAleatorio = (int)(Math.random() * ((5 - 0) + 1)) + 0;
    ...
    public Pregunta obtenerPreguntaAzar() {
        ...
        //ArrayList<Pregunta> preguntas = preguntaService.obtenerPreguntasPorCategoria(juego.getPreguntas(),Categoria.tecnologia);
